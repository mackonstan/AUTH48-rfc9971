# AUTH48 for RFC-to-be 9971 <draft-ietf-bmwg-mlrsearch-15> (in markdown)

This repository is for managing document updates for RFC 9971 during AUTH48. This is part of the [pilot GitHub-based process for AUTH48](https://www.rfc-editor.org/rpc/wiki/doku.php?id=rpc_github_roadmap), and it emulates the [current AUTH48 procedure](https://authors.ietf.org/en/rfc-publication-process). 

Please see the [License](https://github.com/rfc-editor/AUTH48-rfc9971/blob/Approved/LICENSE.md). The [IETF Note Well](https://github.com/rfc-editor/AUTH48-rfc9971/blob/Approved/note-well.md) applies.
...
In addition to the files available in GitHub, the following edited files are available for your review via www.rfc-editor.org:

* [https://www.rfc-editor.org/authors/rfc9971.html](https://www.rfc-editor.org/authors/rfc9971.html)
* [https://www.rfc-editor.org/authors/rfc9971.pdf](https://www.rfc-editor.org/authors/rfc9971.pdf)
* [https://www.rfc-editor.org/authors/rfc9971.txt](https://www.rfc-editor.org/authors/rfc9971.txt)
* [https://www.rfc-editor.org/authors/rfc9971.xml](https://www.rfc-editor.org/authors/rfc9971.xml)

The following diff files are also available:
* [https://www.rfc-editor.org/authors/rfc9971-diff.html](https://www.rfc-editor.org/authors/rfc9971-diff.html) (all changes since the document entered the RFC Editor Queue)
* [https://www.rfc-editor.org/authors/rfc9971-rfcdiff.html](https://www.rfc-editor.org/authors/rfc9971-rfcdiff.html) (side-by-side view of all changes since the document entered the RFC Editor Queue)
 
To create your own output and diff files, use the [IETF Author Tools webservice](https://author-tools.ietf.org/).

## Approving the Document

Once the content is stable in GitHub, the markdown will be converted to RFCXML and formatted as an RFC.  The RPC will then send an email with links to the .html, .pdf, .txt, and .xml files and request final approval of the document.  Your final approval means that you approve both the content and format and that the RFC is ready for publication.
...
The details of the AUTH48 status of the document are here: [https://www.rfc-editor.org/auth48/rfc9971](https://www.rfc-editor.org/auth48/rfc9971)
