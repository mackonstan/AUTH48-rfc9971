...
- Throughput requires a loss of exactly zero frames, but the industry best practices
  frequently allow for tolerance of low but non-zero losses ([Y.1564], test-equipment manuals).
...
Enhancements 1, 2, and partly 4 are formalized as the MLRsearch Specification
...
in a detail sufficient to imply how the Trial Forwarding Ratio should be calculated.
...
by infrequent effects, causing unsatisfactory repeatability of {{RFC2544}} Throughput results. Refer to ["DUT in SUT"](#dut-in-sut)
...
This section uses informal language to describe two aspects of MLRsearch logic: Load Classification and Conditional Throughput,
...
This is followed by an example search.
