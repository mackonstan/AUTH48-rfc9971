...
consisting of DUT1, DUT2 and a WAN link between them.
...
it usually implies proper configuration of constituent DUTs,
...
: The Manager initializes the SUT (constituent DUTs), the Measurer
